  ...
  return (
    ...
    >
      <div className={`${styles.profile_container} ${styles.panel}`}>
        <img src={banner} className={styles.banner_image} alt="banner image" />
        <img
          src={profile_image}
        ...
        <div className={styles.about_me_container}>
          ...
          <p>
            Hi! I'm a student at University of Athens and I am currently studing
            Computer Sciense at Department of Informatics and Telecommunications
          </p>
        </div>
        ...
        <p className={`${styles.view_profile_message} ${styles.panel_link}`}><a href="#">View Profile</a></p>
      </div>
      <div className={`${styles.connections_container} ${styles.panel}`}>
        <div className={styles.network_container}>
          ...
          <p className={`${styles.shoe_all_message} ${styles.panel_link}`}><a href="#">Show All</a></p>
        </div>
      </div>
    </div>
  );
